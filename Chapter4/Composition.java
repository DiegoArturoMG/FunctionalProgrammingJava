...
public class Composition {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(timesTwoMinusOne.apply(10)); // 18

        Function<Integer, Integer> MinusOneTimesTwo = timesTwo.andThen(minusOne);
        System.out.println(MinusOneTimesTwo.apply(10)); // 19

        Employee[] employeesArr = {
                new Employee("Jhon", 34, "developer", 80000f),
                new Employee("Hannah", 24, "developer", 95000f),
                new Employee("Bart", 50, "sales executive", 100000f),
                new Employee("Sophie", 49, "construction worker", 40000f),
                new Employee("Darren", 38, "writer", 50000f),
                new Employee("Nancy", 28, "developer", 75000f),
        };
        ...
        List<String> results = employeeList
                .stream()
